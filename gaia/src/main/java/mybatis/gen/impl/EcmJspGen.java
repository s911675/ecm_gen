...
public class EcmJspGen extends AbstractEcmBaseGen {
	public static final String OUTPUT_FILE_SUFFIX = ".list";
	public static final String OUTPUT_FILE_EXTENSION = ".jsp";
	
	private static final String PROPERTY_ID_OUTPUT_ROOT = "output.root.jsp";
	private static final String PROPERTY_ID_TEMPLATE = "template.jsp";
	private static final String PROPERTY_ID_PATH = "path.jsp";


	public EcmJspGen(VelocityContext context, Connection conn, String tableName, String dbName) throws Exception {
	...
	public String getOutFileName() {
	    return (String)context.get("jspFileName");
	}

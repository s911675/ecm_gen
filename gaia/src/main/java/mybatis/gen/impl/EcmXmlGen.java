...
public class EcmXmlGen extends AbstractEcmBaseGen {
	public static final String OUTPUT_FILE_SUFFIX = "";
	public static final String OUTPUT_FILE_EXTENSION = ".xml";
	
	private static final String PROPERTY_ID_OUTPUT_ROOT = "output.root.xml";
	private static final String PROPERTY_ID_TEMPLATE = "template.xml";
	private static final String PROPERTY_ID_PATH = "path.xml";


	public EcmXmlGen(VelocityContext context, Connection conn, String tableName, String dbName) throws Exception {
	...
	public String getOutFileName() {
	    return (String)context.get("xmlFileName");
	}

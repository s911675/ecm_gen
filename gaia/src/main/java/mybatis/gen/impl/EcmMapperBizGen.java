...
public class EcmMapperBizGen extends AbstractEcmBaseGen {
    public static final String OUTPUT_FILE_SUFFIX = "Mapper";
    public static final String OUTPUT_FILE_EXTENSION = ".java";
	
	private static final String PROPERTY_ID_OUTPUT_ROOT = "output.root.mapperBiz";
	private static final String PROPERTY_ID_TEMPLATE = "template.mapperBiz";
	private static final String PROPERTY_ID_PATH = "pkg.mapperBiz";
	
	public EcmMapperBizGen(VelocityContext context, Connection conn, String tableName, String dbName) throws Exception {
	...
	public String getOutFileName() {
	    return (String)context.get("mapperBizFileName");
	}
